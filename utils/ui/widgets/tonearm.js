...
/** Tonearm resting position (away from record). */
export const TONEARM_PARKED_ANGLE = 25;

/** Tonearm playing position (stylus on groove). */
...
export const Tonearm = GObject.registerClass(
    class Tonearm extends St.DrawingArea {
        ...
        _animateTo(targetAngle) {
            // If already there, do nothing (avoids fighting animations)
            ...
            // Skip trivially short movements
